...
const appConfig$1 = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/Users/tom/dev/tom-moore","order":0,"outDir":"/Users/tom/dev/tom-moore/.vinxi/build/public"},{"name":"client","type":"spa","handler":"index.html","base":"/","root":"/Users/tom/dev/tom-moore","target":"browser","outDir":"/Users/tom/dev/tom-moore/.vinxi/build/client","order":1},{"name":"api","type":"http","handler":"src/api.ts","base":"/api","root":"/Users/tom/dev/tom-moore","target":"server","outDir":"/Users/tom/dev/tom-moore/.vinxi/build/api","order":2}],"server":{},"root":"/Users/tom/dev/tom-moore"};
				const buildManifest = {"client":{"index.html":{"file":"assets/index-B4bxbM77.js","name":"index","src":"index.html","isEntry":true,"dynamicImports":["src/routes/index.lazy.tsx"],"css":["assets/index-DYd0IHBA.css"]},"src/routes/index.lazy.tsx":{"file":"assets/index.lazy-x2uunSvX.js","name":"index.lazy","src":"src/routes/index.lazy.tsx","isDynamicEntry":true,"imports":["index.html"]}},"api":{"virtual:$vinxi/handler/api":{"file":"api.js","name":"api","src":"virtual:$vinxi/handler/api","isEntry":true}}};
...
const assets$1 = {
  "/favicon.svg": {
    "type": "image/svg+xml",
    "etag": "\"1b2-LEmZWrkOmo1bz1hHVQ6RD8TJsEo\"",
    "mtime": "2024-12-19T23:16:39.448Z",
    "size": 434,
    "path": "../public/favicon.svg"
  },
  "/index.html": {
    "type": "text/html; charset=utf-8",
    "etag": "\"734-yWdYh9UpDomcLu5rOS0Don7RGOg\"",
    "mtime": "2024-12-19T23:16:39.451Z",
    "size": 1844,
  ...
  "/robots.txt": {
    ...
    "etag": "\"18-+9ZR6U1BySfGdzvF3y0gGzHDmAo\"",
    "mtime": "2024-12-19T23:16:39.448Z",
    "size": 24,
  ...
  "/.vite/manifest.json": {
    ...
    "etag": "\"1d5-6E8adnzm5gaRJUMmXNphgK1qbNI\"",
    "mtime": "2024-12-19T23:16:39.450Z",
    "size": 469,
    "path": "../public/.vite/manifest.json"
  },
  "/assets/index-B4bxbM77.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"35913-zGgTRid7wH9vP3/y3uqX1ZOzfOg\"",
    "mtime": "2024-12-19T23:16:39.450Z",
    "size": 219411,
    "path": "../public/assets/index-B4bxbM77.js"
  },
  "/assets/index-DYd0IHBA.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"1e10-edUCyVLNYU0LglHnsCU9//FYy5w\"",
    "mtime": "2024-12-19T23:16:39.451Z",
    "size": 7696,
    "path": "../public/assets/index-DYd0IHBA.css"
  },
  "/assets/index.lazy-x2uunSvX.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"2e9c8-KUK8CHOEWpEo4fiAslg4XAyyN+s\"",
    "mtime": "2024-12-19T23:16:39.451Z",
    "size": 190920,
    "path": "../public/assets/index.lazy-x2uunSvX.js"
  },
  "/files/CV.pdf": {
    "type": "application/pdf",
    "etag": "\"43d72-gXWy2q0xJSDfc7AsMjB5hwXGGvg\"",
    "mtime": "2024-12-19T23:16:39.448Z",
    "size": 277874,
...
const _Fv8Z5N = eventHandler((event) => {
...
const f = z.object({ name: z.string().min(1, { message: "Required" }), emailAddress: z.string().email({ message: "Invalid email address" }), message: z.string().min(1, { message: "Required" }) });
function p() {
  return h();
}
const a = Symbol("$HTTPEvent");
function d(t) {
  return typeof t == "object" && (t instanceof H3Event || (t == null ? void 0 : t[a]) instanceof H3Event || (t == null ? void 0 : t.__is_event__) === true);
}
function y(t) {
  return function(...n) {
    var _a;
    let e = n[0];
    if (d(e)) n[0] = e instanceof H3Event || e.__is_event__ ? e : e[a];
    else {
      if (!((_a = globalThis.app.config.server.experimental) == null ? void 0 : _a.asyncContext)) throw new Error("AsyncLocalStorage was not enabled. Use the `server.experimental.asyncContext: true` option in your app configuration to enable it. Or, pass the instance of HTTPEvent that you have as the first argument to the function.");
      if (e = p(), !e) throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");
      n.unshift(e);
    }
    return t(...n);
  };
...
const E = i$3.createTransport({ host: "smtp.gmail.com", port: 587, secure: false, auth: { user: "tommoore.dev@gmail.com", pass: process.env.GMAIL_APP_PASSWORD } });
async function w(t, n, e) {
  const r = { from: n, to: "tommoore.dev@gmail.com", subject: "New Contact Form Submission", text: `Name: ${t}
Email: ${n}
Message: ${e}` };
  try {
    return await E.sendMail(r);
  } catch {
    throw new Error("Failed to send email");
  }
}
const P = eventHandler(async (t) => {
  const n = await g(t), e = f.safeParse(JSON.parse(n));
  return e.success ? (await w(e.data.name, e.data.emailAddress, e.data.message)).accepted ? new Response("Email sent successfully", { status: 200 }) : new Response("Email failed to send", { status: 500 }) : new Response(JSON.stringify({ error: e.error.message }), { status: 400 });
});

const html = "<!doctype html>\n<html lang=\"en\">\n  <head>\n    <meta charset=\"UTF-8\" />\n    <link\n      rel=\"icon\"\n      href=\"data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%22110%22>👨🏻‍💻</text></svg>\"\n    />\n    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\" />\n    <title>Tom Moore | Senior Web Developer - React, TypeScript, Next.js</title>\n\n    <meta\n      name=\"description\"\n      content=\"Tom Moore, senior web developer with 7+ years of experience building clean, reliable, and modern web applications. Specialising in React, TypeScript, and Next.js, I deliver exceptional frontend solutions and full-stack development services.\"\n    />\n\n    <meta\n      name=\"viewport\"\n      content=\"width=device-width, height=device-height, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no\"\n    />\n\n    <meta\n      name=\"keywords\"\n      content=\"Senior Web Developer, Frontend Developer, React Developer, TypeScript, Next.js, Node.js, Freelance Developer, Contract Developer, Modern Web Applications, Tom Moore, Web Development Services, Software Developer\"\n    />\n    <link rel=\"stylesheet\" crossorigin href=\"/assets/index-BcLitM0x.css\" />\n    <link rel=\"preconnect\" href=\"https://fonts.googleapis.com\" />\n    <link rel=\"preconnect\" href=\"https://fonts.gstatic.com\" crossorigin />\n    <link\n      href=\"https://fonts.googleapis.com/css2?family=Inconsolata:wght@200..900&family=Karla:ital,wght@0,200..800;1,200..800&display=swap\"\n      rel=\"stylesheet\"\n    />\n    <script type=\"module\" crossorigin src=\"/assets/index-B4bxbM77.js\"></script>\n    <link rel=\"stylesheet\" crossorigin href=\"/assets/index-DYd0IHBA.css\">\n    <script src=\"/manifest.js\"></script>\n  </head>\n  <body className=\"bg-slate-600\">\n    <div id=\"root\"></div>\n  </body>\n</html>\n";
							const _XWXGQ6 = eventHandler$1(event => {
								return html
							});

const handlers = [
  { route: '', handler: _Fv8Z5N, lazy: false, middleware: true, method: undefined },
  { route: '/api', handler: P, lazy: false, middleware: true, method: undefined },
  { route: '/', handler: _XWXGQ6, lazy: false, middleware: true, method: undefined }
];
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/tom/dev/tom-moore/.data/kv"}));
